  ...
  elseif game:get_value("i1602") == 4 then
    ...
    sol.timer.start(1000, function()
      game:set_value("i1602", 5)
        game:set_dialog_name("Gaira"); game:start_dialog("gaira.4.faron_deacon1", function()
        game:set_dialog_position("top")
        game:set_dialog_name("Deacon"); game:start_dialog("deacon.4.faron", game:get_player_name(), function()
          npc_gaira:set_direction(0)  -- East/Right
          game:set_dialog_position("bottom")
          game:set_dialog_name("Gaira"); game:start_dialog("gaira.4.faron_deacon2", game:get_player_name(), function()
            npc_deacon:set_direction(2) -- West/Left
            game:set_dialog_position("top")
            game:set_dialog_name("Deacon"); game:start_dialog("deacon.4.faron_gaira3", function()
              game:set_dialog_position("bottom")
              game:set_dialog_name("Gaira"); game:start_dialog("gaira.4.faron_deacon4", function()
                game:set_dialog_position("top")
                game:set_dialog_name("Deacon"); game:start_dialog("deacon.4.faron_gaira5", function()

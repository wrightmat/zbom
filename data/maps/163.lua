...
function map:on_started(destination)
  ...
  if game:get_value("i1603") >= 1 and game:get_value("i1603") < 5 then  -- force the initial dialog to be heard
...
function sensor_fairy_speak:on_activated()
  ...
  elseif game:get_value("i1603") == 3 then
    game:start_dialog("great_fairy.3", function()
      if game:get_item("quiver"):get_variant() < 2 then hero:start_treasure("quiver", 2) end
    end)
  ...
  elseif game:get_value("i1603") == 5 then
    game:start_dialog("great_fairy.5.faron", function()
      game:set_value("i1603", 6)
      if game:get_item("quiver"):get_variant() < 3 then hero:start_treasure("quiver", 3) end
    end)
  elseif game:get_value("i1603") == 6 then

...
function map:on_started(destination)
  if game:get_value("i1828") >= 25 then game:set_value("i1604", 2) end
  if game:get_value("i1828") >= 50 then game:set_value("i1604", 3) end
  if game:get_value("i1828") >= 75 then game:set_value("i1604", 4) end
  if game:get_value("i1828") == 99 then game:set_value("i1604", 5) end
end
...
function sensor_fairy_speak:on_activated()
  ...
  elseif game:get_value("i1604") == 3 then
    game:start_dialog("great_fairy.3", function()
      hero:start_treasure("bomb_bag", 2)
    end)

...
function stamina_bar:rebuild_surface()
  ...
  -- Max stamina.
  self.container_img:draw_region(46, 8, 2 + self.max_stamina_displayed/10, 8, self.surface)

  -- Current stamina (divided so it takes up less space).
  self.stamina_bar_img:draw_region(46, 32, 2 + self.stamina_displayed/10, 8, self.surface)
end
